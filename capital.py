...
capital_list = Label(root,bg="blanchedalmond",fg="brown1")
country_list = Label(root,bg="blanchedalmond",fg="brown1")
capital_random = Label(root,bg="blanchedalmond",fg="brown1")
country_random = Label(root,bg="blanchedalmond",fg="brown1")
...
btn = Button(root, text = "Display Country & Capital Name", command = input_data, bg = "brown1", fg = "white")
btn.place(relx = 0.5, rely = 0.4, anchor = CENTER)

country_list.place(relx = 0.5, rely = 0.5, anchor = CENTER)
capital_list.place(relx = 0.5, rely = 0.6, anchor = CENTER)
    
btn1 = Button(root, text = "Display Country & Capital Name Randomly", command = random1, bg = "brown1", fg = "white")
